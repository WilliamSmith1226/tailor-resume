...
Technical Skills:
• Languages: Python, Node.js, Java, JavaScript, TypeScript, SQL, NoSQL, Bash
• Frontend: React, Angular, Vue, Next.js, Redux, RxJS, Material UI, Bootstrap, TailwindCSS
• Backend: Node.js, Express, NestJS, Django, Flask, FastAPI, GraphQL
• AI/ML: OpenAI API, TensorFlow, PyTorch, Scikit-learn, Pandas, NumPy, NLP, CV, RPA (UiPath, Automation Anywhere)
• Cloud & Infra: AWS, Azure, GCP, Docker, Kubernetes, Terraform, Serverless Framework, Prometheus, Grafana
• DevOps: Jenkins, GitHub Actions, GitLab CI, CircleCI, ArgoCD, Helm, Docker Compose
• Databases: MySQL, PostgreSQL, MongoDB, DynamoDB, Redis, Elasticsearch, Firebase
• Testing: Jest, Mocha, Chai, Cypress, Playwright, Selenium, Postman, PyTest, unittest
• Security: OAuth2, JWT, SAML, OIDC, RBAC, OWASP guidelines
• Tools: Jira, Confluence, Trello, Slack, Git, Bitbucket, Figma
